...
<div class="header">
    ...
    <div class="header-right">
        <a class="active" href="${pageContext.request.contextPath}/login.jsp"><fmt:message key="login" bundle="${lang}"/></a>
        <a href="${pageContext.request.contextPath}/register.jsp"><fmt:message key="register" bundle="${lang}"/></a>
