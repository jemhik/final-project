...
<div class="row">
    ...
    <div class="container">
        <h3 class="text-center"><fmt:message key="inProgressCourses" bundle="${lang}"/></h3>
        <hr>
        <br>
        <table class="table table-bordered">
            ...
            <c:forEach var="course" items="${courses}">
                <tr>
                    ...
                    <td><a href="controller?action=startCourse&name=${course.name}" class="btn btn-success"><fmt:message key="continue" bundle="${lang}"/></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
